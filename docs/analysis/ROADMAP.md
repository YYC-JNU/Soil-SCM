...
| **v0.7.x** | 规划 | **地球化学深化**（工单 77~81）：GAS_PHASE 固定缓冲动态化（fertilizer<4.0 关键）+ KNOBS 高离子强度收敛调优（30 年全量解锁）+ weathering 情景区分（natural off / fertilizer on）+ lime 盐基淋失强化 + HX log_k 微调重锚定；详见 HANDOFF §5.1 + `docs/analysis/V0_7_0_ACCEPTANCE.md` |
