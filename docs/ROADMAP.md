...
| v0.2.6 | 2026-08-13 | L2 矿物演化回填：修复 Al 耗尽根因（Q12* 根治，pH 不再突升）；85 用例全绿 |
| v0.3.0 | 2026-08-14 | L4 硝化两步（库存层，N→N₂ 约束）+ L5 电荷平衡修正（HCO₃⁻/pCO₂ 自洽、Cl 兜底）；102 用例全绿 |
| v0.4.0 | 2026-08-14 | L9 MINERAL_SCALE 扫描（参数/非晶质相无效结论，深层方向立项）+ 非晶质 Al(OH)₃ 相 + L1 Al 表面简化方法报告；103 用例全绿 |
| v0.5.0 | 2026-08-14 | 三支柱：缺口补齐参数化（GAP_AL_FRACTION=0.3，初始 pH 自洽）+ 预平衡（交换离子锚定，不锚定 pH）+ L9 交换选择性证伪（结构性局限确认）；113 用例全绿 |
| v0.6.0 | 2026-08-14 | Al 动力学（KINETICS）：gibbsite/Al(OH)₃(a) 速率控制阻断 Al 汇，2 年 AlX₃ 稳定；117 用例全绿 |
| v0.6.1 | 2026-08-14 | KINETICS 回退（证据否定：冻结矿物切断 L2 回补、排水淋失为耗尽主因）+ 子进程超时机制保留；115 用例全绿 |
