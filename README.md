...
> **当前版本**：**v0.7.2**（2026-08-31 更新发布：工单 83 **深层 CEC/BS 物理化** + 工单 84 **验证探针 + natural 碱化归因** + 工单 85 **30y 权威基线** + 工单 87 **深层极端酸化物理化** + 工单 86 **L4 收敛分层架构**；**365 测试**）+ **v0.7.1**（2026-08-25：工单 82 L4 深层盐基运移数值稳定化，30y 全量解锁）+ 地球化学深化（工单 77/78/80，见 §十一）
