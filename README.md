...
>   上游独立性结构论证 + 探针实测 y1~y7 L1 pH 与物理化前逐位一致）；深层关联链
>   证伪；计算量：难步率 30.8%→21.8%、L3 占比 33%→12%（物理化数值收益）、L4 仍
>   占 71%（工单 86 靶心）（详见 spec 84 + `docs/analysis/V0_7_x_ALKALIZATION_ATTRIBUTION.md`）
